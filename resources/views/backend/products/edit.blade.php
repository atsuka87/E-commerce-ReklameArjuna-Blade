                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6">
                                ...
                                <textarea id="description" name="description" rows="4" required
                                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500 sm:text-sm">{{ old('description', $product->description) }}</textarea>
                            </div>
                            ...
                            <div class="col-span-6">
                                <div class="flex items-start">
                                    <div class="flex h-5 items-center">
                                        <input id="allow_custom" name="allow_custom" type="checkbox" value="1" {{ $product->allow_custom ? 'checked' : '' }}
                                               class="h-4 w-4 rounded border-gray-300 text-yellow-600 focus:ring-yellow-500">
                                    </div>
                                    <div class="ml-3 text-sm">
                                ...
                                <div class="space-y-2">
                                    <div class="flex items-center">
                                        <input id="custom_text" name="custom_options[]" value="custom_text" type="checkbox" 
                                               @if(in_array('custom_text', $product->custom_options ?? [])) checked @endif
                                               class="h-4 w-4 rounded border-gray-300 text-yellow-600 focus:ring-yellow-500">
                                    ...
                                    <div class="flex items-center">
                                        <input id="custom_size" name="custom_options[]" value="custom_size" type="checkbox"
                                               @if(in_array('custom_size', $product->custom_options ?? [])) checked @endif
                                               class="h-4 w-4 rounded border-gray-300 text-yellow-600 focus:ring-yellow-500">
                                    ...
                                    <div class="flex items-center">
                                        <input id="custom_color" name="custom_options[]" value="custom_color" type="checkbox"
                                               @if(in_array('custom_color', $product->custom_options ?? [])) checked @endif
                                               class="h-4 w-4 rounded border-gray-300 text-yellow-600 focus:ring-yellow-500">
                                    ...
                                    <div class="flex items-center">
                                        <input id="upload_logo" name="custom_options[]" value="upload_logo" type="checkbox"
                                               @if(in_array('upload_logo', $product->custom_options ?? [])) checked @endif
                                               class="h-4 w-4 rounded border-gray-300 text-yellow-600 focus:ring-yellow-500">
